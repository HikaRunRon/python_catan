from __future__ import print_function        ########クライアントの騎士アクションを担うファイル
import socket
import sys
import pygame
...
def client_knight(Knight,screen,Mapdata_Mass,Mapdata_Side,Mapdata_Edge,Player_Data,land,landnumber,backlog,yourturn,rightside,front,leftside,Dice1,Dice2,bufsize,bandit_pos,sock,readfds,Winner,running,running1,Thisturn_draw,volume):
  if Knight[0]:
