from __future__ import print_function       ########クライアントの街道建設(ノーマル)を担うファイル
import socket
import sys
import pygame
...
def client_road_building(screen,Mapdata_Mass,Mapdata_Side,Mapdata_Edge,Player_Data,land,landnumber,backlog,yourturn,rightside,front,leftside,Dice1,Dice2,road_running,sock,bufsize,Winner,running1,running,readfds,volume):
