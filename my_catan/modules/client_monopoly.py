...
def client_monopoly(Monopoly,sock,screen,Mapdata_Mass,Mapdata_Side,Mapdata_Edge,Player_Data,land,landnumber,backlog,yourturn,rightside,front,leftside,Monopoly_list,Dice1,Dice2,bufsize,readfds,Thisturn_draw,volume):
  while Monopoly[0]:
