...
def client_city_building(screen,Mapdata_Mass,Mapdata_Side,Mapdata_Edge,Player_Data,land,landnumber,backlog,yourturn,rightside,front,leftside,Dice1,Dice2,city_running,sock,bufsize,Winner,running,running1,readfds,volume):
