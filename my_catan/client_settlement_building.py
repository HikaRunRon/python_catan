...
def client_settlement_building(screen,Mapdata_Mass,Mapdata_Side,Mapdata_Edge,Player_Data,land,landnumber,backlog,yourturn,rightside,front,leftside,Dice1,Dice2,settlement_running,sock,bufsize,Winner,running1,running,readfds):
